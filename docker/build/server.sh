...
START_ARGUMENTS="-publicip=${IP_SERVER} -port=${PORT_SERVER} -publicport=${PORT_API} -queryport=${PORT_QUERY} -players=${PLAYER_COUNT} ${ADDITIONAL_COMMANDS} -NumberOfWorkerThreadsServer=${THREAD_COUNT} -logformat=text"
